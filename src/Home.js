...
class Home extends Component {
  render() {
    return (
      <div  style={{backgroundImage: `url(${logo})`, height:"85vh", backgroundSize:"cover", color:"white", textAlign:"center", backgroundRepeat: "no-repeat", textShadow: "-2px 0 black, 0 2px black, 2px 0 black, 0 -2px black"}}>
        <br></br><br></br><br></br>
